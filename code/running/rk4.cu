...
__device__ void calculate_rk4_coeff(double *X, double *S, double *S_prev, double rk_weight, double l_br, double l_bz, double l_bt, double eperm, double timestep){
...
__device__ void calculate_rk4_coeff(double *X, double *S, double *S_prev, double rk_weight, double l_br, double l_bz,  double l_bt, double l_er, double l_ez, double l_et, double eperm, double timestep){
...
__device__ void solve_diffeq(double *X, double l_br, double l_bz, double l_bt, double eperm, double timestep){
...
__device__ void solve_diffeq(double *X, double l_br, double l_bz, double l_bt, double l_er, double l_ez, double l_et, double eperm, double timestep){
