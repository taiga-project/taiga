int spline_read_and_init(ShotProp shot, RunProp run, char* field_name, double ***return_s_ptr, int dimRZ){
    ...
    double *S0,  *s0;  read_vector(&S0, "input/fieldSpl", shot.name, concat(field_name ,".spl11", NULL), suc);    cudaMalloc((void **) &s0,  dimRZ);
    double *S1,  *s1;  read_vector(&S1, "input/fieldSpl", shot.name, concat(field_name ,".spl12", NULL), suc);    cudaMalloc((void **) &s1,  dimRZ);
    double *S2,  *s2;  read_vector(&S2, "input/fieldSpl", shot.name, concat(field_name ,".spl13", NULL), suc);    cudaMalloc((void **) &s2,  dimRZ);
    double *S3,  *s3;  read_vector(&S3, "input/fieldSpl", shot.name, concat(field_name ,".spl14", NULL), suc);    cudaMalloc((void **) &s3,  dimRZ);
    double *S4,  *s4;  read_vector(&S4, "input/fieldSpl", shot.name, concat(field_name ,".spl21", NULL), suc);    cudaMalloc((void **) &s4,  dimRZ);
    double *S5,  *s5;  read_vector(&S5, "input/fieldSpl", shot.name, concat(field_name ,".spl22", NULL), suc);    cudaMalloc((void **) &s5,  dimRZ);
    double *S6,  *s6;  read_vector(&S6, "input/fieldSpl", shot.name, concat(field_name ,".spl23", NULL), suc);    cudaMalloc((void **) &s6,  dimRZ);
    double *S7,  *s7;  read_vector(&S7, "input/fieldSpl", shot.name, concat(field_name ,".spl24", NULL), suc);    cudaMalloc((void **) &s7,  dimRZ);
    double *S8,  *s8;  read_vector(&S8, "input/fieldSpl", shot.name, concat(field_name ,".spl31", NULL), suc);    cudaMalloc((void **) &s8,  dimRZ);
    double *S9,  *s9;  read_vector(&S9, "input/fieldSpl", shot.name, concat(field_name ,".spl32", NULL), suc);    cudaMalloc((void **) &s9,  dimRZ);
    double *S10, *s10; read_vector(&S10,"input/fieldSpl", shot.name, concat(field_name ,".spl33", NULL), suc);    cudaMalloc((void **) &s10,  dimRZ);
    double *S11, *s11; read_vector(&S11,"input/fieldSpl", shot.name, concat(field_name ,".spl34", NULL), suc);    cudaMalloc((void **) &s11,  dimRZ);
    double *S12, *s12; read_vector(&S12,"input/fieldSpl", shot.name, concat(field_name ,".spl41", NULL), suc);    cudaMalloc((void **) &s12,  dimRZ);
    double *S13, *s13; read_vector(&S13,"input/fieldSpl", shot.name, concat(field_name ,".spl42", NULL), suc);    cudaMalloc((void **) &s13,  dimRZ);
    double *S14, *s14; read_vector(&S14,"input/fieldSpl", shot.name, concat(field_name ,".spl43", NULL), suc);    cudaMalloc((void **) &s14,  dimRZ);
    double *S15, *s15; read_vector(&S15,"input/fieldSpl", shot.name, concat(field_name ,".spl44", NULL), suc);    cudaMalloc((void **) &s15,  dimRZ);
